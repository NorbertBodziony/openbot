...
// Named rather than positional, like the per-domain registrars below.
// `setupFile`, `analyticsPreferenceFile` and `updatePreferenceFile` are three
// paths of the same type: passed positionally, swapping two compiles cleanly
// and writes one preference into another's file, which nothing would catch.
