...
import { registerAgentIpcHandlers } from "./ipc-handlers/agent-handlers";
import { registerAppIpcHandlers } from "./ipc-handlers/app-handlers";
import { registerBrowserIpcHandlers } from "./ipc-handlers/browser-handlers";
import { registerMarketplaceIpcHandlers } from "./ipc-handlers/marketplace-handlers";
import { registerVoiceAuthIpcHandlers } from "./ipc-handlers/voice-auth-handlers";
...
function registerIpcHandlers(
  ...
  registerVoiceAuthIpcHandlers({ voice, centralAuth });
  ...
  registerBrowserIpcHandlers({ browser, browserPictureInPicture, remoteServers });
}
